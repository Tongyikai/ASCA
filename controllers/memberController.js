...
function updateProfileMember(token, uploadAvatar) {
    console.log("會員修改個人資料");
    ...
    if (tokenExist(token)) {
        ...
        client.connect(err => {
            ...
            let base64 = base64Code(uploadAvatar);
            let whereStr = { "memberID": memberID };
            let updateStr = { $set: { "avatar": base64, "familyName": "陳", "givenName": "宮" }};
